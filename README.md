# Caffe customization with dynamic fixed point quantization simulation 
  - Base code
    - Caffe Windows port: https://github.com/BVLC/caffe/tree/windows
    - Ristretto for CNN approximation: https://github.com/pmgysel/caffe
  - Customizations
    - More dynamic fixed point layers for PReLU, Deconv that have not been supported or incomplete in original Ristretto.
    - Some different quantization policies.
    - 'hard_tanh' layer implementation: a piecewise linear approximation of 'tanh'
